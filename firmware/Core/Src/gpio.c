...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ADC_SPI_CS_Pin|ADC_START_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ADC_SPI_CS_Pin ADC_START_Pin */
  GPIO_InitStruct.Pin = ADC_SPI_CS_Pin|ADC_START_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
